...
namespace Lab2Employee
{
    internal class Wages : Employee
    {
        ...
        public Wages(string id, string name, string address, string phone, long sin, string dob, string dept, double rate, double hour) : base(id, name, address, phone, sin, dob, dept) 
        { 
            this.Rate = rate;
            this.Hour = hour;
        }
        ...
        public override double GetPay()
        {
            if (this.Hour > 40)
            {
                double pay = this.Rate * 40 + this.Rate * 1.5 * (this.Hour - 40);
                return pay;
            }
        ...
        {
            string formatted = "";
            formatted += "This is a wage employee:\n";
